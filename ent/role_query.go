...
// FirstID returns the first Role UserId from the query.
// Returns a *NotFoundError when no Role UserId was found.
func (rq *RoleQuery) FirstID(ctx context.Context) (id int16, err error) {
	var ids []int16
...
func (rq *RoleQuery) FirstIDX(ctx context.Context) int16 {
...
// OnlyID is like Only, but returns the only Role UserId in the query.
// Returns a *NotSingularError when more than one Role UserId is found.
// Returns a *NotFoundError when no entities are found.
func (rq *RoleQuery) OnlyID(ctx context.Context) (id int16, err error) {
	var ids []int16
...
func (rq *RoleQuery) OnlyIDX(ctx context.Context) int16 {
...
func (rq *RoleQuery) IDs(ctx context.Context) (ids []int16, err error) {
...
func (rq *RoleQuery) IDsX(ctx context.Context) []int16 {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.Assign = func(columns []string, values []any) error {
				outValue := int16(values[0].(*sql.NullInt64).Int64)
...
func (rq *RoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(role.Table, role.Columns, sqlgraph.NewFieldSpec(role.FieldID, field.TypeInt16))
	_spec.From = rq.sql
